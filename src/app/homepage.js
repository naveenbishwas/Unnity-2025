            ...
            <div className="project-section-df">
              ...
              <div className="project-content">
                ...
                <p>
                  ...
                  developed a modern, scalable website on Shopify to showcase
                  their wide product range — from CEO chairs to modular
                  workstations. The goal was to create a high-performing,
                  SEO-friendly, and easy-to-manage storefront that could handle
                  a large and growing catalog.
                </p>

                <ul>
                  <li>
                    Massive catalogs with advanced filtering and organization
                  </li>
                  <li>Dealer listings and reseller information</li>
                  <li>
                    Certification highlights such as ISO 9001 and OHSAS 45001
                  </li>
                </ul>
                <br />
                <br />
                ...
                <p>
                  <b>1. Partial Payment Option:</b> Since Dá Urban deals in both
                  B2B and B2C, implementing a reliable partial payment method
                  was crucial. However, finding a Shopify-compatible app or
                  custom solution that matched their product and pricing
                  structure wasn't straightforward. After multiple trials, I
                  identified and integrated a partial payment system that
                  allowed flexibility for larger orders without complicating the
                  checkout flow.
                </p>
                <p>
                  <b>2. Dynamic Service Kit in Cart:</b> Every product required
                  a specific service kit to be shown in the cart as an optional
                  add-on. To tackle this, I customized the cart logic to
                  dynamically display relevant service kits per item, improving
                  upselling opportunities while keeping the UX intuitive.
                </p>
                <p>
                  <b>3. Bulk Enquiry Page:</b> For B2B clients, I built a
                  dedicated Bulk Enquiry page with a smart form allowing users
                  to submit detailed requirements. This helped separate bulk
                  leads from regular traffic and made follow-ups easier for the
                  sales team.
                </p>
              </div>
            </div>
            ...
            <div className="project-section-df rotate" id="portfolio-two">
              ...
              <div className="project-content">
                ...
                <p>
                  ...
                  opportunity to build a robust and scalable digital presence
                  that reflects their industrial strength and modern engineering
                  capabilities. The focus of the project was to highlight their
                  expertise in pre-engineered buildings (PEB), factory sheds,
                  and cold storage structures—sectors where visual impact and
                  technical trust matter deeply.
                  <br />
                  <br />
                  Working closely with their team, I translated their complex
                  offerings into a functional and visually striking design. The
                  entire site was built using Next.js, leveraging server-side
                  rendering and static site generation for optimal performance
                  and SEO.
                  <br />
                  <br />
                  The layout was crafted to be responsive, easy to navigate, and
                  focused on client conversion — making it simple for potential
                  clients to explore the brand’s solutions and reach out for
                  customized requirements. Every design decision emphasized
                  engineering precision, innovation, and execution capacity,
                  which are central to the Devkinandan brand.
                </p>
                <br />
                ...
                <p id="next-js">
                  <b>1. Balancing Product Info with Project Visuals:</b> In the
                  industrial sector, showing technical product specifications is
                  essential — but for Devkinandan, it was even more important to
                  showcase completed projects through images. Clients wanted to
                  see execution quality over just reading about it. I redesigned
                  content flow to prioritize project imagery and real-world
                  applications without compromising on key technical content.
                  Image galleries, case study snippets, and scroll-triggered
                  project displays helped strike the right balance.
                </p>
                <p>
                  <b>2. Optimizing Heavy Image Assets in Next.js:</b> With a
                  visual-first approach, managing large image files without
                ...
                <p>
                  ...
                  sections had dynamic content (like project categories or
                  services), setting up clean and SEO-friendly URLs required
                  careful configuration. I used dynamic routing with static
                  generation to keep the site fast and crawlable by search
                  engines.
                </p>
                <p>
                  <b>4. Common UI Consistency Issues:</b> Cross-browser and
                  cross-device consistency with layout elements (especially the
                  custom grid sections for industrial work display) required
                  extra debugging — particularly in legacy mobile browsers.
                </p>
              </div>
            </div>
          </div>
